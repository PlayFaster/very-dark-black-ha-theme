...
*   **Inheritance (Anchors/Aliases)**: To avoid "Duplicate Key" warnings, ensure that your base anchor contains *only* shared settings. If the base anchor defines a color (e.g., Cyan) and a sub-theme overrides it (e.g., Green), HA will log a warning about duplicate keys.
